...
const Banner = ({ increaseCoins }) => {
  return (
    <div className='px-28'>
      <div className="flex flex-col justify-center items-center gap-4 text-center py-24 bg-cover bg-no-repeat text-white bg-[#000000] rounded-3xl" style={{ backgroundImage: 'url(bg-shadow.png)' }}>
        <img className='mx-auto mb-7 w-72' src="banner-main.png" alt=""/>
